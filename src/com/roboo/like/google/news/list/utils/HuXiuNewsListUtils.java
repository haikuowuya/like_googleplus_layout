...
public class HuXiuNewsListUtils extends BaseNewsListUtils
{
	...
	public static LinkedList<NewsItem> getHuXiuNewsList(String huXiuUrl, int pageNo) throws Exception
	{
		...
		String title = null, subTitle = null,source="虎嗅网", md5 = null, time = null, src = null, newsUrl = null;
	...
	{
		return getHuXiuNewsList(baseUrl, pageNo);
	}
}
