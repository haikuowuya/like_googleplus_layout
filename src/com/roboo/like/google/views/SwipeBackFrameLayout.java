...
import com.roboo.like.google.views.helper.ViewDragHelper;
...
public class SwipeBackFrameLayout extends FrameLayout {
    ...
    public SwipeBackFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SwipeBackFrameLayout, defStyle,
                R.style.SwipeBackFrameLayout);
        ...
        int shadowLeft = a.getResourceId(R.styleable.SwipeBackFrameLayout_shadow_left,
                R.drawable.shadow_left);
        int shadowRight = a.getResourceId(R.styleable.SwipeBackFrameLayout_shadow_right,
                R.drawable.shadow_right);
        int shadowBottom = a.getResourceId(R.styleable.SwipeBackFrameLayout_shadow_bottom,
