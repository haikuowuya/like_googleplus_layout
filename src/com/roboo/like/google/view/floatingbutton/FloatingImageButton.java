package com.roboo.like.google.view.floatingbutton;
...
public class FloatingImageButton extends ImageButton
{
	...
	{
		TypedArray attr = getTypedArray(context, attributeSet, R.styleable.FloatingImageButton);
		if (attr != null)
		{
			try
			{
				mColorNormal = attr.getColor(R.styleable.FloatingImageButton_fab_colorNormal, getColor(android.R.color.holo_blue_dark));
				mColorPressed = attr.getColor(R.styleable.FloatingImageButton_fab_colorPressed, getColor(android.R.color.holo_blue_light));
				mShadow = attr.getBoolean(R.styleable.FloatingImageButton_fab_shadow, true);
				mType = attr.getInt(R.styleable.FloatingImageButton_fab_type, TYPE_NORMAL);
			}
			finally
			{
				attr.recycle();
	...
	private Drawable createDrawable(int color)
	{
		...
		if (mShadow)
		{
			LayerDrawable layerDrawable = new LayerDrawable(new Drawable[] { getResources().getDrawable(R.drawable.ic_shadow), shapeDrawable });
	...
	private class ScrollSettleHandler extends Handler
	{
		...
		{
			animate().setInterpolator(mInterpolator).setDuration(TRANSLATE_DURATION_MILLIS).translationY(mSettledScrollY);
		}
	}
	...
	/**
	 * A {@link android.os.Parcelable} representing the {@link com.FloatingImageButton.fab.FloatingActionButton}'s state.
	 */
